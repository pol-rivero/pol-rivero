...
<ul>
  <li>He/Him, 21 years old (as of December 12, 2022)</li>
  <li>
    <p>I'm currently studying Software Engineering at the 
      <img align="top" src="img/UPC_logo.png" alt="UPC Logo" width="20" height="20">
      UPC (BarcelonaTech).</p>
  </li>
  <li>I made 3 public GitHub commits during November 2022. Fun fact: 3 is a triangle is the only figure which, if all endpoints have hinges, will never change its shape unless the sides themselves are bent. 🤓</li>
</ul> 
